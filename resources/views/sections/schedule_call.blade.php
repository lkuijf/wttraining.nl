            ...
            <div class="columns">
                <div>
                    <form action="{{ route('submitScheduleCall') }}" method="POST">
                        ...
                        <div class="formRow">
                            <div><img src="{{ asset('statics/contact-user.png') }}" alt="naam"></div>
                        ...
                        <div class="formRow">
                            <div><img src="{{ asset('statics/contact-email.png') }}" alt="naam"></div>
                        ...
                        <div class="formRow">
                            <div><img src="{{ asset('statics/contact-company.png') }}" alt="naam"></div>
                            <div><input type="text" name="company" value="{{ old('company') }}" placeholder="Bedrijfsnaam"></div>
                        </div>
                        <div class="formRow">
                            <div><img src="{{ asset('statics/contact-phone.png') }}" alt="naam"></div>
